...
\usepackage{subfig}
\usepackage{tikz}
\usetikzlibrary{arrows, er, positioning, matrix}
\tikzset{
...
\pretitle{%
	...
	%% autor ------------------------------------------------------------------
	\noindent
	{\Large $\longeq$ Dokumentace zkouškového příkladu $\longeq$} \\ [0.5cm]
	{\Large $\longeq$ pro předmět 4IT218 Databáze $\longeq$} \\ [2.5cm]
	
	
	%% autor ------------------------------------------------------------------
	\noindent
	{\large MUDr. Lubomír Štěpánek}
	...
	{***} \\
	{\large \textit{Zimní semestr 2017/2018}}
